...
var Overview=React.createClass({displayName: "Overview",
  ...
  renderResult: function(item,index) {
  	return (React.createElement("option", {value: item[1]}, item[0]));
  },
  render: function() {
